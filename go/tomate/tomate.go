...
func parseChar(str []rune, index int) (patternItem, int) {
	...
	switch str[1] {
	case 'n':
		return patternItem{class: classBreak}, 2
	case 'N':
		return patternItem{class: classBreak, negate: true}, 2
	case 'a':
		return patternItem{class: classLetter}, 2
	case 'A':
		return patternItem{class: classLetter, negate: true}, 2
	case 'd':
		return patternItem{class: classDigits}, 2
	case 'D':
		return patternItem{class: classDigits, negate: true}, 2
	case 's':
		return patternItem{class: classWhitespace}, 2
	case 'S':
		return patternItem{class: classWhitespace, negate: true}, 2
	case 'l':
		return patternItem{class: classLowercase}, 2
	case 'u':
		return patternItem{class: classUppercase}, 2
	case 'w':
		return patternItem{class: classAlphanum}, 2
	case 'W':
		return patternItem{class: classAlphanum, negate: true}, 2
	default:
		return patternItem{class: classChar, val: str[1]}, 2
	}
}
